...
async function startServer() {
  ...
  // Final fallback for API or unmatched routes to help debug CORS + 404
  app.use((req, res) => {
    ...
    res.status(404).json({ error: "Route not found", method: req.method, url: req.url, path: req.path });
  });
